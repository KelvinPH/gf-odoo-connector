...
### 1.6.1
- Fixed country resolver for GF values like `Netherlands (NL)`; prevented false matches (Nigeria/Niger, etc.).
...
### 1.4.2
- CRM lead First name and Last name fields; multi-field mapping to combine GF fields into one Odoo text field; fixed feed template editor save for field mappings.
